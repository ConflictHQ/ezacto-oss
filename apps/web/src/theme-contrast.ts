import { contrastRatio } from '@ezacto/core'
import type { ThemeDefinition, ThemeSlot } from './theme.js'

// The arithmetic lives in `@ezacto/core` because the instance-palette rule
// (#591) holds operator-supplied colours to these same ratios, and two
// implementations of WCAG luminance could disagree about whether a palette is
// readable. Re-exported here so this module stays the shell's one door to it.
