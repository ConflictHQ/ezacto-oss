...
export type ProfitabilityReportEnvelope = {
...
export class EzactoClient {
  ...
  async listInvoices(args: { query?: { "cursor"?: string; "per_page"?: number; "state"?: string; "client_id"?: string }; signal?: AbortSignal; headers?: HeadersInit } = {}): Promise<InvoicePage> {
    const headers = new Headers(args.headers);
  ...
  async listRetainers(args: { query?: { "cursor"?: string; "per_page"?: number; "client_id"?: string }; signal?: AbortSignal; headers?: HeadersInit } = {}): Promise<RetainerPage> {
    const headers = new Headers(args.headers);
